 ...
 * 2. Substitua todos os valores marcados com test-club
...
export const testClubTenant: TenantConfig = {
  // ============================================
  // IDENTIFICAÇÃO (OBRIGATÓRIO)
  // ============================================
  id: 'test-club',           // Ex: 'meu-clube'
  slug: 'test-club',         // Ex: 'meu-clube' (usado na URL /t/meu-clube)
  name: 'Clube do Osvaldo',         // Ex: 'Meu Clube'
  ...
  // ============================================
  logo: '/tenants/test-club/logo.svg',    // Criar em public/tenants/[slug]/
  favicon: '/tenants/test-club/favicon.svg',  // OPCIONAL: favicon customizado
  brandText: {
    line1: 'Clube',    // Ex: 'MEU'
    line2: 'SAAS',   // Ex: 'CLUBE.'
  },
  tagline: 'Tenant de teste',      // Ex: 'Sua tagline aqui'
  description: 'Tenant de teste',  // Descrição para SEO
  ...
  // ============================================
hero: {
  title: 'Clube do Osvaldo',
  subtitle: 'Assinatura de teste para validar a plataforma multi-tenant.',
  cta: 'Começar Agora',
    // images: ['/tenants/test-club/hero-1.jpg'],  // OPCIONAL: imagens do carrossel
  },
  ...
  // ============================================
 legal: {
  companyName: 'Clube do Osvaldo LTDA',
  cnpj: '00.000.000/0001-00',
  address: 'São Paulo - SP',
},

seo: {
  title: 'Clube do Osvaldo | Assinatura de Teste',
  description: 'Tenant de teste para validar a plataforma multi-tenant.',
  keywords: ['teste', 'assinatura', 'saas'],
},
